...
PAGES = {
    "home":     ("/",         "CrossAnx",                   "home",     ""),
    "files":    ("/files",    "Files - CrossAnx",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("/settings", "Settings - CrossAnx Reader", "settings", ""),
    "fonts":    ("/fonts",    "Fonts - CrossAnx",           "fonts",    ""),
}
...
if __name__ == "__main__":
    ...
    print(f"CrossAnx web preview: http://localhost:{port}  (Ctrl+C to stop)")
    try:
        httpd.serve_forever()
